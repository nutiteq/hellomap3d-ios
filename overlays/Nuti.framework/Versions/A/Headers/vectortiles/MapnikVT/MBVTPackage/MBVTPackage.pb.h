...
void  protobuf_AddDesc_MBVTPackage_2eproto();
void protobuf_AssignDesc_MBVTPackage_2eproto();
void protobuf_ShutdownFile_MBVTPackage_2eproto();
...
class Tile_Value : public ::google::protobuf::MessageLite {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_MBVTPackage_2eproto();
  friend void protobuf_AssignDesc_MBVTPackage_2eproto();
  friend void protobuf_ShutdownFile_MBVTPackage_2eproto();
...
inline void Tile_Feature::set_type(::vector_tile::Tile_GeomType value) {
  GOOGLE_DCHECK(::vector_tile::Tile_GeomType_IsValid(value));
  set_has_type();
  type_ = value;
}
