...
/**
 * A raster tile data source that loads tiles using a HTTP connection.<br>
 ...
 */
@interface NTHTTPRasterTileDataSource : NTRasterTileDataSource
-(void*)getCptr;
-(id)initWithCptr: (void*)cptr swigOwnCObject: (BOOL)ownCObject;
/**
 * Constructs a HTTPRasterTileDataSource object.<br>
