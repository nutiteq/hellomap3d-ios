...
/**
 * A vector tile data source that loads tiles from a local Sqlite database.<br>
 ...
 */
@interface NTMBTilesVectorTileDataSource : NTVectorTileDataSource
-(void*)getCptr;
-(id)initWithCptr: (void*)cptr swigOwnCObject: (BOOL)ownCObject;
/**
 * Constructs a MBTilesVectorTileDataSource object.<br>
