#ifndef BALLOONPOPUPSTYLEBUILDER_H_
#define BALLOONPOPUPSTYLEBUILDER_H_
...
public:
     ...
     */
    const UIImage* getLeftImage() const;
    /**
     ...
     */
    void setLeftImage(const UIImage* leftImage);
    /**
     ...
     */
    const UIImage* getRightImage() const;
    /**
     ...
     */
    void setRightImage(const UIImage* rightImage);
    /**
...
protected:
	...
	Color _leftColor;
    const UIImage* _leftImage;
    BalloonPopupMargins _leftMargins;
    
    Color _rightColor;
    const UIImage* _rightImage;
