...
private:
  std::uint32_t _has_bits_[1];
  ::NMLPackage::Vector3 min_ = ::NMLPackage::Vector3();
  ::NMLPackage::Vector3 max_ = ::NMLPackage::Vector3();
};
// -------------------------------------------------------------------
...
public:
  ...
  inline void set_format(::NMLPackage::Texture_Format format) { format_ = format; }
...
private:
  ...
  ::NMLPackage::Sampler sampler_ = ::NMLPackage::Sampler();
...
private:
  std::uint32_t _has_bits_[1];
  ::NMLPackage::ColorRGBA color_ = ::NMLPackage::ColorRGBA();
...
private:
  ...
  int type_ = 1;
  int culling_ = 1;
  ::NMLPackage::ColorOrTexture emission_ = ::NMLPackage::ColorOrTexture();
  ::NMLPackage::ColorOrTexture ambient_ = ::NMLPackage::ColorOrTexture();
  ::NMLPackage::ColorOrTexture diffuse_ = ::NMLPackage::ColorOrTexture();
...
public:
  ...
  inline const std::vector< ::NMLPackage::Submesh >& submeshes() const;

  // @@protoc_insertion_point(class_scope:NMLPackage.Mesh)
private:
  std::uint32_t _has_bits_[1];
  ::std::string id_ = "";
  ::NMLPackage::Bounds3 bounds_ = ::NMLPackage::Bounds3();
  std::vector< ::NMLPackage::Submesh > submeshes_;
};
// -------------------------------------------------------------------
...
public:
  ...
  inline const std::vector< ::NMLPackage::Material >& materials() const;
...
private:
  std::uint32_t _has_bits_[1];
  ::std::string mesh_id_ = "";
  std::vector< ::NMLPackage::Material > materials_;
  ::NMLPackage::Matrix4 transform_ = ::NMLPackage::Matrix4();
};
// -------------------------------------------------------------------
...
public:
  ...
  inline const std::vector< ::NMLPackage::SubmeshOp >& submesh_ops() const;

  // @@protoc_insertion_point(class_scope:NMLPackage.SubmeshOpList)
private:
  std::uint32_t _has_bits_[1];
  ::std::string material_id_ = "";
  std::vector< ::NMLPackage::SubmeshOp > submesh_ops_;
  int type_ = 1;
};
// -------------------------------------------------------------------
...
public:
  ...
  inline const std::vector< ::NMLPackage::SubmeshOpList >& submesh_op_lists() const;
...
private:
  ...
  ::std::string id_ = "";
  ::NMLPackage::Bounds3 bounds_ = ::NMLPackage::Bounds3();
  std::vector< ::NMLPackage::SubmeshOpList > submesh_op_lists_;
};
// -------------------------------------------------------------------
...
public:
  ...
  inline const std::vector< ::NMLPackage::MeshInstance >& mesh_instances() const;
  ...
  inline const std::vector< ::NMLPackage::Mesh >& meshes() const;
  ...
  inline const std::vector< ::NMLPackage::Texture >& textures() const;
...
private:
  std::uint32_t _has_bits_[1];
  ::std::string id_ = "";
  std::vector< ::NMLPackage::MeshInstance > mesh_instances_;
  std::vector< ::NMLPackage::Mesh > meshes_;
  std::vector< ::NMLPackage::Texture > textures_;
  ::NMLPackage::Bounds3 bounds_ = ::NMLPackage::Bounds3();
...
private:
  std::uint32_t _has_bits_[1];
  ::NMLPackage::Bounds3 bounds_ = ::NMLPackage::Bounds3();
  ::NMLPackage::Model model_ = ::NMLPackage::Model();
...
public:
  ...
  inline const std::vector< ::NMLPackage::ModelLODTreeNode >& nodes() const;

  // @@protoc_insertion_point(class_scope:NMLPackage.ModelLODTree)
private:
  std::uint32_t _has_bits_[1];
  std::vector< ::NMLPackage::ModelLODTreeNode > nodes_;
};
// ===================================================================
...
inline Bounds3::Bounds3(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kMinFieldNumber) {
      min_ = ::NMLPackage::Vector3(msg.read_message());
      _has_bits_[0] |= 0x00000001u;
    }
    else if (msg.tag == kMaxFieldNumber) {
      max_ = ::NMLPackage::Vector3(msg.read_message());
      _has_bits_[0] |= 0x00000002u;
    }
    else msg.skip();
  }
...
inline Texture::Texture(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kIdFieldNumber) {
      ...
      sampler_ = ::NMLPackage::Sampler(msg.read_message());
      _has_bits_[0] |= 0x00000010u;
    }
...
inline ColorOrTexture::ColorOrTexture(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kTypeFieldNumber) {
      ...
      color_ = ::NMLPackage::ColorRGBA(msg.read_message());
      _has_bits_[0] |= 0x00000002u;
    }
...
inline Material::Material(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kIdFieldNumber) {
      ...
      emission_ = ::NMLPackage::ColorOrTexture(msg.read_message());
      _has_bits_[0] |= 0x00000008u;
    }
    else if (msg.tag == kAmbientFieldNumber) {
      ambient_ = ::NMLPackage::ColorOrTexture(msg.read_message());
      _has_bits_[0] |= 0x00000010u;
    }
    else if (msg.tag == kDiffuseFieldNumber) {
      diffuse_ = ::NMLPackage::ColorOrTexture(msg.read_message());
      _has_bits_[0] |= 0x00000020u;
    }
...
inline Mesh::Mesh(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kIdFieldNumber) {
      ...
      bounds_ = ::NMLPackage::Bounds3(msg.read_message());
      _has_bits_[0] |= 0x00000002u;
    }
...
inline const std::vector< ::NMLPackage::Submesh >& Mesh::submeshes() const {
...
inline MeshInstance::MeshInstance(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kMeshIdFieldNumber) {
      ...
      transform_ = ::NMLPackage::Matrix4(msg.read_message());
      _has_bits_[0] |= 0x00000004u;
    }
    else msg.skip();
  }
...
inline const std::vector< ::NMLPackage::Material >& MeshInstance::materials() const {
...
inline const std::vector< ::NMLPackage::SubmeshOp >& SubmeshOpList::submesh_ops() const {
...
inline const std::vector< ::NMLPackage::SubmeshOpList >& MeshOp::submesh_op_lists() const {
...
inline const std::vector< ::NMLPackage::MeshInstance >& Model::mesh_instances() const {
...
inline const std::vector< ::NMLPackage::Mesh >& Model::meshes() const {
...
inline const std::vector< ::NMLPackage::Texture >& Model::textures() const {
...
inline ModelLODTreeNode::ModelLODTreeNode(const protobuf::message& srcMsg) {
  ...
  for (protobuf::message msg(srcMsg); msg.next(); ) {
    if (msg.tag == kIdFieldNumber) {
      ...
      model_ = ::NMLPackage::Model(msg.read_message());
      _has_bits_[0] |= 0x00000004u;
    }
...
inline const std::vector< ::NMLPackage::ModelLODTreeNode >& ModelLODTree::nodes() const {
