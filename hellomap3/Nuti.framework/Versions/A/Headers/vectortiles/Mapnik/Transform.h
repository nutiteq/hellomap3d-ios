...
#ifndef _NUTI_MAPNIK_TRANSFORM_H_
#define _NUTI_MAPNIK_TRANSFORM_H_
...
namespace Nuti { namespace Mapnik {
	...
	public:
		MatrixTransform(const cglib::mat3x3<float>& matrix) : _matrix(matrix) { }
	...
	public:
		RotateTransform(const cglib::vec2<float>& pos, float angle) : _pos(pos), _angle(angle) { }
	...
	public:
		ScaleTransform(const cglib::vec2<float>& scale) : _scale(scale) { }
	...
	public:
		SkewXTransform(float angle) : _angle(angle) { }
	...
	public:
		SkewYTransform(float angle) : _angle(angle) { }
