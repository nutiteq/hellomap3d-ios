...
#ifndef _NUTI_MAPNIKVT_TRANSFORMPARSER_H_
#define _NUTI_MAPNIKVT_TRANSFORMPARSER_H_
...
namespace Nuti { namespace MapnikVT {
	...
	template <typename Iterator> using TransformParser = TransformParserImpl::Grammar<Iterator>;
} }
