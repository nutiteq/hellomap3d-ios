...
#ifndef _NUTI_MAPNIKVT_COLORGENERATOR_H_
#define _NUTI_MAPNIKVT_COLORGENERATOR_H_
...
namespace Nuti { namespace MapnikVT {
    ...
    template <typename Iterator> using ColorGenerator = ColorGeneratorImpl::Grammar<Iterator>;
} }
