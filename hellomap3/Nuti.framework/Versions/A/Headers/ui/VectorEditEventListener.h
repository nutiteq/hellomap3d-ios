...
namespace Nuti {
    ...
    public:
         ...
         */
        virtual bool onElementSelect(const std::shared_ptr<VectorElement>& element) = 0;
        /**
         * Called when element is unselected.
         * @param element The element which was unselected
         */
        virtual void onElementDeselected(const std::shared_ptr<VectorElement>& element) = 0;
		 ...
		 */
        virtual VectorElementDragResult::VectorElementDragResult onDragStart(const std::shared_ptr<VectorElementDragInfo>& dragInfo) = 0;
         ...
         * @result The intended result of dragging.
		 */
        virtual VectorElementDragResult::VectorElementDragResult onDragMove(const std::shared_ptr<VectorElementDragInfo>& dragInfo) = 0;
         ...
         * @result The intended result of dragging.
		 */
        virtual VectorElementDragResult::VectorElementDragResult onDragEnd(const std::shared_ptr<VectorElementDragInfo>& dragInfo) = 0;
